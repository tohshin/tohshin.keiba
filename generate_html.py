            ...
            if (svc === 'ipat' || svc === 'umaca') {{
                ...
                bodyHtml = `
                    <div style="margin-bottom: 12px; display: flex; align-items: center; gap: 8px;">
                        ...
                        <input type="number" id="${{unitId}}" value="100" step="100" min="100" style="width: 80px; padding: 4px 8px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: #fff; border-radius: 6px; font-size: 0.75rem; text-align: right;" oninput="${{updateFn}}()">
                        <span style="font-size: 0.75rem; color: #cbd5e1;">円</span>
                        <span style="flex: 1; text-align: right; font-size: 0.75rem; color: #94a3b8;">
                            合計: <strong id="${{totalId}}" style="color: ${{color}};">100円</strong>
                        </span>
                    </div>

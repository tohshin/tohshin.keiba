        ...
        function checkHits(payoutData) {{
            ...
            strategyItems.forEach(item => {{
                ...
                if (winNums.length > 0) {{
                    ...
                    if (type.includes('3連単') && type.includes('マルチ')) {{
                        eyesCount *= 6;
                    }}
                    ...
                    if (isHit && resultArea) {{
                        ...
                        resultArea.innerHTML = `
                            <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.05); display: flex; justify-content: space-between; font-size: 0.75rem;">
                                ...
                                <div><span style="color:var(--text-muted);">Payout:</span> <span style="color:#fbbf24; font-weight:700;">${{totalPay.toLocaleString()}}円</span></div>

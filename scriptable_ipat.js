...
async function main() {
  ...
  (function() {
    ...
    try {
      ...
      if ((elU || elP || elR) && bodyText.indexOf("エラー") >= 0 && (bodyText.indexOf("加入者番号") >= 0 || bodyText.indexOf("暗証番号") >= 0 || bodyText.indexOf("022/1010") >= 0)) {
      ...
      if (isConfirmScreen) {
        ...
        dg("🎉 【全" + bets.length + "件セット完了】 内容を確認し【投票】ボタンを押してください！", "rgba(16,185,129,0.95)");
        return { status: "DONE" };
      }
